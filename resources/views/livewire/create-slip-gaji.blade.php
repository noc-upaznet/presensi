                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="month" id="month"
                                class="form-control @error('bulanTahun') is-invalid @enderror"
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                ...
                                <div class="input-group mb-2">
                                    <span class="input-group-text">Rp</span>
                                    <input type="text" id="lembur_nominal" class="form-control" disabled
                                        wire:model="lembur_nominal">
                                </div>
                            </div>
                            <div class="mb-3 col-md-6">
                                ...
                                <div class="input-group mb-2">
                                    <span class="input-group-text">Rp</span>
                                    <input type="text" id="lemburLibur_nominal" class="form-control" disabled
                                        wire:model="lemburLibur_nominal">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                <label for="fee_sharing_nominal" class="form-label fw-semibold">Bonus Fee
                                    Sharing</label>
                                <div class="input-group mb-2">
                                    <span class="input-group-text">Rp</span>
                                        ...
                                        @if (!empty($jenis_tunjangan) && $jenis_tunjangan->count())
                                            @foreach ($jenis_tunjangan as $t)
                                                @if (!in_array($t->id, $tunjangan_terpilih ?? []))
                                                    <option value="{{ $t->nama_tunjangan }}">{{ $t->nama_tunjangan }}
                                                    </option>
                                                @endif
                                            @endforeach
                                        @else
                        ...
                        <div class="row mt-3">
                            <div class="col-md-2 mb-3">
                                ...
                                <input type="text" class="form-control" value="{{ $rekap['kehadiran'] }}"
                                    readonly>
                            </div>
                            <div class="col-md-2 mb-3">
                                <label for="terlambat" class="form-label fw-semibold">Terlambat (Hari)</label>
                                <input type="text" class="form-control" value="{{ $rekap['terlambat'] }}"
                                    readonly>
                            </div>
                            <div class="col-md-2 mb-3">
