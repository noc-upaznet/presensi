                    ...
                    @if ($tab == 'dashboard')
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-6">
                                <div class="small-box text-bg-success">
                                    <div class="inner pe-5">
                                        <h4>Rp. {{ number_format($kasbon, 0, ',', '.') }}</h4>
                                        <span><b>Total Kasbon</b></span>
                                    </div>
                                    <svg class="small-box-icon" fill="currentColor" viewBox="0 0 24 24"
                                        xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                        <path
                        ...
                        @livewire('payroll.note-dashboard-payroll', ['selectedMonth' => $selectedMonth, 'selectedYear' => $selectedYear])
                    @endif
