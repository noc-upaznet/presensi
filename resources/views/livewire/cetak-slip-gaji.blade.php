...
<body>
    ...
    <div class="header">
        <div class="logo-container">
            <div style="flex: 1; text-align: left; display: flex;">
                <img src="./assets/img/upaznet-logonew.png" alt="Logo" class="logo">
                <h2 style="margin: 0 0 0 15px; font-size: 14px;">PT Zemangat Anak Bangsa</h2>
            </div>
            <div style="flex: 2; text-align: right;">
                <h3 style="margin: 0; font-size: 14px;">SLIP GAJI</h3>
            </div>
        </div>
    </div>
