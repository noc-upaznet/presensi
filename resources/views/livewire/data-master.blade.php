<div>
    <div class="app-content-header mb-4">
        ...
        <div class="container-fluid">
            ...
            <div class="row mb-4">
                <div class="col-sm-6">
                    <h3 class="mb-0" style="color: var(--bs-body-color);">Data Master</h3>
                </div>
                <div class="col-sm-6">
            ...
            <div class="app-content" id="tab-role-users">
                ...
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist"
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link fw-bold @if ($tab == 'pills-question') active @endif"
                            wire:click='setTab("pills-question")' id="pills-question-tab" data-bs-toggle="tab"
                            data-bs-target="#pills-question" data-tab-name="pills-question" type="button"
                            role="tab" aria-controls="pills-question" aria-selected="true">Bank Soal</button>
                    </li>
                </ul>
                <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="tab-pane fade @if ($tab == 'pills-question') active show @endif "
                        id="pills-question" role="tabpanel" aria-labelledby="pills-question-tab">

                        @if ($tab == 'pills-question')
                            <livewire:question-bank.question-bank />
                        @endif
