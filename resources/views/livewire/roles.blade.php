<div>
    <div class="mb-4">
        <h4 class="mb-4" style="color: var(--bs-body-color);">Roles User</h4>
        <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#modalAddRoles"><i class="fa-solid fa-plus"></i> Tambah Roles</button>
        <!-- /.card-header -->
    </div>
        ...
        <table class="table table-striped table-hover mb-0" style="background-color: var(--bs-body-bg);">
            ...
            <tbody>
                @foreach ($roles as $key)
                    <tr>
                        <td style="color: var(--bs-body-color);">{{ $key->user->name }}</td>
                        <td style="color: var(--bs-body-color);">{{ $key->role }}</td>
                        <td>
