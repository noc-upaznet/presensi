        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <div wire:ignore>
                        <select name="permissions[]" wire:model='form.user_permissions'
                            id="select-permissions-modal-create-user"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <div wire:ignore>
                        <select name="permissions[]" wire:model='form.user_permissions'
                            id="select-permissions-modal-edit-user"
                            class="w-100 form-select  @error('form.user_permissions') is-invalid @enderror"
                            multiple="multiple">
                            @foreach ($user_permissions as $value => $label)
                                <option value="{{ $value }}">
                ...
                <div class="mb-3">
                    ...
                    <div wire:ignore>
                        <select name="status" wire:model='form.status' id="status"
                            class="w-100 form-select @error('form.status') is-invalid @enderror">
