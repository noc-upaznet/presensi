                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Maksimal Jumlah</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button wire:click.prevent="confirmHapusPotongan({{ $item->id }})"
    ...
    <div wire:ignore.self class="modal fade" id="tambahJenisPotonganModal" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content" style="border-radius: 0.375rem; border-top: 4px solid #007bff; border-left: 1px solid #dee2e6;
                ...
                <form wire:submit.prevent="storePotongan">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="maksimal_jumlah" class="form-label">Maksimal Jumlah</label>
                            <input type="number" class="form-control" id="maksimal_jumlah" wire:model="maksimal_jumlah"
                                required>
                        </div>
                    </div>
