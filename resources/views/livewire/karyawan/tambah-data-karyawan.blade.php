                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="d-flex justify-content-center align-items-center mb-5 mt-4"
                            ...
                            <div class="text-center mx-5">
                                <div class="rounded-circle {{ $step >= 1 ? 'bg-primary text-white' : 'bg-light text-dark' }} d-inline-flex align-items-center justify-content-center"
                                    style="width: 50px; height: 50px;">
                                    1
                                </div>
                                <div><small>Data Personal</small></div>
                            </div>
                            <div class="step-line {{ $step > 1 ? 'bg-primary text-white' : 'bg-light text-dark' }}">
                            </div>
                            <div class="text-center mx-5">
                                <div class="rounded-circle {{ $step >= 2 ? 'bg-primary text-white' : 'bg-light text-dark' }} d-inline-flex align-items-center justify-content-center"
                                    style="width: 50px; height: 50px;">
                                    2
                                </div>
                                <div><small>Data Ketenagakerjaan</small></div>
                            </div>
                            <div class="step-line {{ $step > 2 ? 'bg-primary text-white' : 'bg-light text-dark' }}">
                            </div>
                            <div class="text-center mx-5">
                                <div class="rounded-circle {{ $step >= 3 ? 'bg-primary text-white' : 'bg-light text-dark' }} d-inline-flex align-items-center justify-content-center"
                                    style="width: 50px; height: 50px;">
                                    3
                                </div>
                        ...
                        <div class="container" style="color: var(--bs-body-color);">
                            @if ($step === 1)
                                ...
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="nama_karyawan"
                                            name="nama_karyawan" wire:model="form.nama_karyawan" required>
                                ...
                                <div class="row">
                                        ...
                                        <div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="laki-laki"
                                                    value="Laki-laki" wire:model="form.jenis_kelamin"
                                                    name="jenis_kelamin">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select" id="status_perkawinan"
                                            wire:model="form.status_perkawinan" name="status_perkawinan">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label for="agama" class="form-label">Agama <small
                                                class="text-danger">*</small></label>
                                        <select class="form-select" wire:model="form.agama" id="agama"
                                            name="agama">
                                ...
                                <div align="right">
                                    @if ($step > 1)
                                        <button type="button" wire:click="prevStep" class="btn btn-secondary"><i
                                                class="bi bi-arrow-left-circle-fill"></i> Kembali</button>
                                    @endif

                                    @if ($step < 3)
                                        <button type="button" wire:click="nextStep"
                                            class="btn btn-primary">Selanjutnya <i
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select" id="status-karyawan"
                                            wire:model="form.status_karyawan">
                                            <option selected disabled value="">-- Pilih Status Karyawan --
                                            </option>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select" id="jabatan" wire:model="form.jabatan">
                                            ...
                                            @foreach ($jabatan as $key)
                                                <option value="{{ $key->nama_jabatan }}">{{ $key->nama_jabatan }}
                                                </option>
                                            @endforeach
                                        </select>
                                        @error('form.jabatan')
                            ...
                            @if ($step === 3)
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control" id="gaji_pokok"
                                                oninput="formatRupiah(this)" wire:model.lazy="form.gaji_pokok"
                                                readonly />
                                        </div>
                                        ...
                                        <div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio"
                                                    name="jenis_penggajian" id="bulanan" value="Bulanan"
                                                    wire:model="form.jenis_penggajian">
                                                <label class="form-check-label" for="bulanan">Bulanan</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio"
                                                    name="jenis_penggajian" id="harian" value="Harian"
                                                    wire:model="form.jenis_penggajian">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label for="nama-pemilik-rekening" class="form-label">Nama Pemilik Rekening
