<div>
  <div class="app-content-header">
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-sm-6">
          <h3 class="mb-0" style="color: var(--bs-body-color);">Data Karyawan</h3>
        </div>
        <div class="col-sm-6">
    ...
    <div class="container-fluid">
      <div class="mb-4">
        <div class="card-header">
          <a href="{{ route('tambah-data-karyawan') }}"><button class="btn btn-primary"><i class="fa-solid fa-plus"></i>
              Tambah</button></a>
          <button wire:click="showModalImport" class="btn btn-success"><i class="fa-solid fa-file-excel"></i>
            Import</button>
        </div>
        <!-- /.card-header -->
      </div>
        ...
        <table class="table table-striped table-hover mb-0" style="background-color: var(--bs-body-bg);">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="color: var(--bs-body-color);"><span class="badge-success">{{ $key->status_karyawan }}</span>
              </td>
              <td style="color: var(--bs-body-color);">{{ $key->email }}</td>
              {{-- <td style="color: var(--bs-body-color);">password123</td> --}}
              <td class="text-center">
                <button type="button" wire:click="DetailDataKaryawan({{ $key->id }})" class="btn btn-info btn-sm"><i
