            ...
            <div class="modal-content" style="background-color: var(--bs-body-bg);">
                ...
                <div class="modal-body" style="color: var(--bs-body-color);">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control" id="nama_karyawan" name="nama_karyawan"
                                    wire:model="form.nama_karyawan" required>
                                @error('form.nama_karyawan')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="no-hp" class="form-label">No HP <small
                                        class="text-danger">*</small></label>
                                <input type="text" class="form-control" id="no-hp" name="no_hp"
                                    wire:model="form.no_hp" required>
                                @error('form.no_hp')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="tempat-lahir" class="form-label">Tempat Lahir <small
                                        class="text-danger">*</small></label>
                                <input type="text" class="form-control" id="tempat-lahir" name="tempat_lahir"
                                    wire:model="form.tempat_lahir" required>
                                @error('form.tempat_lahir')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="tgl-lahir" class="form-label">Tanggal Lahir <small
                                        class="text-danger">*</small></label>
                                <input type="date" class="form-control" id="tgl-lahir" name="tanggal_lahir"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="jenis-kelamin" class="form-label">Jenis Kelamin <small
                                        class="text-danger">*</small></label>
                                <div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" id="laki-laki" value="Laki-laki"
                                            wire:model="form.jenis_kelamin" name="jenis_kelamin">
                                        <label class="form-check-label" for="laki-laki">Laki-laki</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" id="perempuan" value="Perempuan"
                                            name="jenis_kelamin" wire:model="form.jenis_kelamin">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="status_perkawinan" class="form-label">Status Perkawinan <small
                                        class="text-danger">*</small></label>
                                <select class="form-select" id="status_perkawinan" wire:model="form.status_perkawinan"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="gol_darah"
                                    wire:model="form.gol_darah" name="gol_darah">
                                @error('form.gol_darah')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-md-6 mb-3">
                        ...
                        <div class="row" x-data="{ jenis: @entangle('form.jenis_identitas'), nomorKTP: @entangle('form.nomorKTP'), errorKTP: '' }">
                            <div class="col-md-6 mb-3">
                                <label for="jenisIdentitas" class="form-label">Jenis Identitas <small
                                        class="text-danger">*</small></label>
                            ...
                            <div class="col-md-6 mb-3" x-show="jenis === 'KTP'">
                                <label for="nomorKTP" class="form-label">Nomor KTP/ NIK <small
                                        class="text-danger">*</small></label>
                                <input type="text" class="form-control" maxlength="16"
                                    placeholder="Masukkan Nomor KTP / NIK" wire:model="form.nomorKTP"
                                    x-on:input="
                            ...
                            <div class="col-md-6 mb-3" x-show="jenis === 'VISA'">
                                <label for="nomorVISA" class="form-label">Nomor VISA <small
                                        class="text-danger">*</small></label>
                                <input type="text" class="form-control" placeholder="Masukkan Nomor VISA"
                        ...
                        <div>
                            ...
                            <div class="form-check mt-3">
                                <input class="form-check-input" type="checkbox" id="copyAlamatEdit"
                                    wire:click="toggleGunakanAlamatKTP" @checked($form->gunakanAlamatKTP)>

                                <label class="form-check-label" for="copyAlamatEdit">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select" wire:model.live="form.provinsiDomisili"
                                            wire:key="dom-provinsi-{{ $karyawanId }}-{{ $form->provinsiDomisili }}">
                                            <option value="">-- Pilih Provinsi --</option>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select" wire:model.live="form.kabupatenDomisili"
                                            wire:key="dom-kabupaten-{{ $karyawanId }}-{{ $form->provinsiDomisili }}-{{ $form->kabupatenDomisili }}"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select" wire:model.live="form.kecamatanDomisili"
                                            wire:key="dom-kecamatan-{{ $karyawanId }}-{{ $form->kabupatenDomisili }}-{{ $form->kecamatanDomisili }}"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select" wire:model.live="form.desaDomisili"
                                            wire:key="dom-desa-{{ $karyawanId }}-{{ $form->kecamatanDomisili }}-{{ $form->desaDomisili }}"
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea class="form-control" rows="3" placeholder="Contoh: Jl. Diponegoro No. 10, RT 02/RW 03"
                                            wire:model.defer="form.alamatDomisili" @disabled($form->gunakanAlamatKTP)></textarea>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="nip-karyawan" class="form-label">NPK/NIP Karyawan <small
                                        class="text-danger">*</small></label>
                                <input type="text" class="form-control" id="nip-karyawan"
                                    wire:model="form.nip_karyawan" name="nip_karyawan">
                                @error('form.nip_karyawan')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="status-karyawan" class="form-label">Status Karyawan <small
                                        class="text-danger">*</small></label>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="tgl-masuk" class="form-label">Tanggal Masuk Kerja <small
                                        class="text-danger">*</small></label>
                                <input type="date" class="form-control" id="tgl-masuk"
                                    wire:model="form.tgl_masuk" required>
                                @error('form.tgl_masuk')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="tgl-keluar" class="form-label">Tanggal Berakhir Kerja <small
                                        class="text-danger">*</small></label>
                                <input type="date" class="form-control" id="tgl-keluar"
                                    wire:model="form.tgl_keluar" required>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="entitas" class="form-label">Entitas <small
                                        class="text-danger">*</small></label>
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="divisi" class="form-label">Divisi <small
                                        class="text-danger">*</small></label>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="jabatan" class="form-label">Jabatan <small
                                        class="text-danger">*</small></label>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="gaji-pokok" class="form-label">Gaji Pokok <small
                                        class="text-danger">*</small></label>
                                <div class="input-group mb-3">
                                    <span class="input-group-text" id="gaji-pokok">Rp.</span>
                                    <input type="text" class="form-control" id="gaji_pokok"
                                        oninput="formatRupiah(this)" wire:model.lazy="form.gaji_pokok" readonly />
                                </div>
                                @error('form.gaji_pokok')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="tunjangan-jabatan" class="form-label">Tunjangan Jabatan <small
                                        class="text-danger">*</small></label>
                                <div class="input-group mb-3">
                                    <span class="input-group-text" id="tunjangan-jabatan">Rp.</span>
                                    <input type="text" class="form-control" id="tunjangan_jabatan"
                                        oninput="formatRupiah(this)" wire:model.lazy="form.tunjangan_jabatan"
                                        readonly />
                                </div>
                                @error('form.tunjangan_jabatan')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" id="bonus"
                                        oninput="formatRupiah(this)" wire:model.lazy="form.bonus" />
                                </div>
                                @error('form.bonus')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" id="inov_reward"
                                        oninput="formatRupiah(this)" wire:model.lazy="form.inov_reward" />
                                </div>
                                @error('form.inov_reward')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="kebudayaan" class="form-label">Tunjangan Kebudayaan</label>
                                <div class="input-group mb-3">
                                    <span class="input-group-text" id="kebudayaan">Rp.</span>
                                    <input type="text" class="form-control" id="kebudayaan"
                                        oninput="formatRupiah(this)" wire:model.lazy="form.kebudayaan" />
                                </div>
                                @error('form.kebudayaan')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group mb-3">
                                    <span class="input-group-text" id="transport">Rp.</span>
                                    <input type="text" class="form-control" id="transport"
                                        oninput="formatRupiah(this)" wire:model.lazy="form.transport" />
                                </div>
                                @error('form.transport')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" id="voucher"
                                        oninput="formatRupiah(this)" wire:model.lazy="form.voucher" />
                                </div>
                                @error('form.voucher')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="jenis-penggajian" class="form-label">Jenis Penggajian <small
                                        class="text-danger">*</small></label>
                                <div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="jenis_penggajian"
                                            id="bulanan" value="Bulanan" wire:model="form.jenis_penggajian">
                                        <label class="form-check-label" for="bulanan">Bulanan</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="jenis_penggajian"
                                            id="harian" value="Harian" wire:model="form.jenis_penggajian">
                                        <label class="form-check-label" for="harian">Harian</label>
                                    </div>
                                </div>
                                @error('form.jenis_penggajian')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="nama-pemilik-rekening" class="form-label">Nama Pemilik Rekening <small
                                        class="text-danger">*</small></label>
                                <input class="form-control" id="nama-pemilik-rekening"
                                    wire:model="form.nama_pemilik_rekening">
                                @error('form.nama_pemilik_rekening')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                @error('form.npp_bpjs_tk')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="tgl-aktif-bpjstk" class="form-label">Tanggal Aktif BPJS
                                Ketenagakerjaan</label>
                            <input type="date" class="form-control" id="tgl-aktif-bpjstk"
                                wire:model="form.tgl_aktif_bpjstk">
                            @error('form.tgl_aktif_bpjstk')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="row">
