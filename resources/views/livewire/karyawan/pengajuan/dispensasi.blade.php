...
<div>
    <div class="app-content-header">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h3 class="mb-0" style="color: var(--bs-body-color);">Daftar Pengajuan Dispensasi</h3>
                </div>
                <div class="col-sm-6">
                                ...
                                @foreach ($pengajuanDispens as $key)
                                    <tr>
                                        ...
                                        <td style="color: var(--bs-body-color);">
                                            @if ($key->file)
                                                @php
                                                    $fileUrl = route('file.dispensasi', encrypt(basename($key->file)));
                                                @endphp
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalGambarLabel">Bukti Dispensasi</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Tutup"></button>
                </div>
