<div>
    ...
    {{-- <div>
        ...
        <div class="container">
            <a href="{{ route('tambah-data-karyawan') }}"><button class="btn btn-primary"><i
                        class="fa-solid fa-plus"></i> Tambah</button></a>
            <button class="btn btn-success"><i class="fa-solid fa-file-excel"></i> Import</button>
            <div class="users-table table-wrapper" style="margin-top: 20px;">
                <table class="posts-table table-striped">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>password123</td>
                            <td>
                                <button type="button" class="btn btn-primary" style="font-size: 10px;"><i
                                        class="fa-solid fa-eye"></i></button>
                                <button type="button" class="btn btn-warning" style="font-size: 10px;"><i
