        ...
        <div class="users-table table-wrapper" style="margin-top: 20px;">
            <table class="posts-table table-striped">
                ...
                <tbody>
                    ...
                    <td>password123</td>
                    <td>
                        <button type="button" class="btn btn-primary" style="font-size: 10px;"><i class="fa-solid fa-eye"></i></button>
                        <button type="button" class="btn btn-warning" style="font-size: 10px;"><i class="fa-solid fa-pen"></i></button>
                    </td>
                    </tr>
                </tbody>
            </table>
