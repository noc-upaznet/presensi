...
<body>
    <img src="{{ asset('assets/img/logo.png') }}" alt="Watermark Logo" class="watermark">
    <div class="content-wrapper">
        ...
        <table class="signature">
            ...
            <tr>
                <td style="border: none;">
                    <img src="{{ asset('assets/img/ttd_hrd.jpg') }}" alt="Tanda Tangan HRD" style="width: 120px;"><br>
